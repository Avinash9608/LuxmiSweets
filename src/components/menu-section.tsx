...
const menuItems = {
  cakes: [
    { name: "Chocolate Truffle Cake", price: "₹800", image: "https://placehold.co/300x200.png", hint: "chocolate cake" },
    { name: "Red Velvet Cake", price: "₹950", image: "https://placehold.co/300x200.png", hint: "red velvet cake" },
    { name: "Pineapple Paradise", price: "₹750", image: "https://placehold.co/300x200.png", hint: "pineapple cake" },
    { name: "Classic Cheesecake", price: "₹1200", image: "https://placehold.co/300x200.png", hint: "cheesecake" },
  ],
  sweets: [
    { name: "Kaju Katli", price: "₹1100/kg", image: "https://placehold.co/300x200.png", hint: "indian sweets" },
    { name: "Motichoor Laddu", price: "₹600/kg", image: "https://placehold.co/300x200.png", hint: "ladoo" },
    { name: "Golden Jalebi", price: "₹550/kg", image: "https://placehold.co/300x200.png", hint: "jalebi" },
    { name: "Royal Gulab Jamun", price: "₹500/kg", image: "https://placehold.co/300x200.png", hint: "gulab jamun" },
  ],
  drinks: [
    { name: "Mango Lassi", price: "₹150", image: "https://placehold.co/300x200.png", hint: "mango lassi" },
    { name: "Rose Sherbet", price: "₹120", image: "https://placehold.co/300x200.png", hint: "rose drink" },
    { name: "Cold Coffee", price: "₹180", image: "https://placehold.co/300x200.png", hint: "cold coffee" },
    { name: "Fresh Lime Soda", price: "₹100", image: "https://placehold.co/300x200.png", hint: "lime soda" },
  ],
};
