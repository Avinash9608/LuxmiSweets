...
const MenuItemCard = ({ name, price, image, hint }: { name: string; price: string; image: string; hint: string }) => (
  <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
    ...
    <CardContent className="p-4 bg-card">
      ...
      <CardDescription className="text-base text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#FFD1FF] dark:from-accent dark:to-primary font-semibold mt-1">{price}</CardDescription>
    </CardContent>
  </Card>
);
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#FFD1FF] dark:from-accent dark:to-primary">Our Menu</h2>
